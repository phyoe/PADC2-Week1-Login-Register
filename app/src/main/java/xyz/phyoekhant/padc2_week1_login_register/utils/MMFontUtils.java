package xyz.phyoekhant.padc2_week1_login_register.utils;
...
import xyz.phyoekhant.padc2_week1_login_register.components.CustomTypefaceSpan;
...
public class MMFontUtils {
    ...
    static {
        Context context = CarPweSarApp.getContext();
    ...
    public static void applyMMFontToTabLayout(TableLayout tl) {
